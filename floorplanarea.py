...
class RoomAreaOverlay(ui.View):
	...
	def touch_began(self,touch):
		'''when starting a touch, we set the current point, and force a redraw.  but we won't add the point as final until we lift our finger.
		If implementing an editable point function, this is where you would look through existing points to find one near current touch
		'''
